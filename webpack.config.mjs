...
import config from './config/configBuilder.mjs';
import { stringifyObjectValues } from './config/helpers.mjs';
...
function createWebConfig(name) {
  return merge(commonConfig, {
    ...
    entry: {
      ...
      'pushwoosh-widget-web-popups': './src/pushwoosh-widget-web-popups.ts',
    },
...
const npmConfig = merge(commonConfig, {
  ...
  entry: {
    ...
    'widget-web-popups': './src/widget-web-popups.ts',
  },
